...
Widget MachanicsCheck(BuildContext context, MediaQueryData mediaQuery) {
  return Container(
    height: 280.h,
    ...
    child: Column(
      children: [
        ...
        Container(
          ...
          child: ListTile(
            title: AppTexts()
                .customAppNormalText(title: " Maintenance Service", size: 14.sp),
            trailing: IconButton(
                onPressed: () {},
                icon: const Icon(
                  Icons.arrow_upward_outlined,
          ...
          onTap: (){
            Navigator.of(context) .push(
                MaterialPageRoute(builder: (v){
                  return NearestForYou(nearest: "Mechanics Station",id: 'Mechanics Check',);
                })
            );
          },
          child: Container(
