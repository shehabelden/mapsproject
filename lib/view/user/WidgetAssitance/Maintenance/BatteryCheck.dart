...
Widget BatteryCheck(BuildContext context, MediaQueryData mediaQuery) {
  return Container(
    height: 280.h,
          ...
          child: Center(
            child: ListTile(
              ...
              leading: AppImages().assetImageWithWidthAndHeight(
                  AppImagesPath.bettaryCheck, 30.w, 30.h),
              trailing: IconButton(
                  onPressed: () {
          ...
          onTap: (){
            Navigator.of(context) .push(
                MaterialPageRoute(builder: (v){
                  return NearestForYou(nearest: "Battery Station",id: 'Battery Check',);
                })
            );
          },
          child: Container(
