...
Widget ComputerCheck(BuildContext context, MediaQueryData mediaQuery) {
  return Container(
    height: 280.h,
          ...
          child: Center(
            child: ListTile(
              ...
              leading: AppImages().assetImageWithWidthAndHeight(
                  AppImagesPath.ComputerIcone, 30.w, 30.h),
              trailing: IconButton(
                  onPressed: () {
          ...
          onTap: (){
            Navigator.of(context) .push(
                MaterialPageRoute(builder: (v){
                  return NearestForYou(nearest: "Computer Station",id: 'Computer Check',);
                })
            );
          },
          child: Container(
