...
Widget RegularMaintenance(BuildContext context, MediaQueryData mediaQuery) {
  return Container(
    height: 280.h,
    ...
    child: Column(
      children: [
        ...
        Container(
          ...
          child: ListTile(
            title: AppTexts()
                .customAppNormalText(title: "Another Service", size: 14.sp),
            trailing: IconButton(
                onPressed: () {},
                icon: const Icon(
                  Icons.arrow_upward_outlined,
          ...
          onTap: (){
            Navigator.of(context) .push(
                MaterialPageRoute(builder: (v){
                  return NearestForYou(nearest: "Regular Station",id: 'Regular Maintenance',);
                })
            );
          },
          child: Container(
