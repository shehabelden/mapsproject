...
Widget CarWashingWidget(BuildContext context, MediaQueryData mediaQuery) {
  return Container(
    height: 280.h,
          ...
          onTap: (){
            Navigator.of(context) .push(
                MaterialPageRoute(builder: (v){
                  return NearestForYou(nearest: "Washing Station",id: 'Car Winsh',);
                })
            );
          },
          child: Container(
